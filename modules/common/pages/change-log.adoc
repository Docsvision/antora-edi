...
* Описан класс `xref:dv6@programmer:Edi:api/BoxesService.adoc[BoxesService]` для выполнения стандартных операций.
+
...
* Добавлены xref:dv6@programmer:Edi:api/web-server-methods.adoc[методы] для серверного и клиентского расширения {wc}а.
* Добавлено описание для следующих классов:
** `xref:dv6@programmer:Edi:api/DataReaderService.adoc[DataReaderService]`
** `xref:dv6@programmer:Edi:api/DocumentUpdaterService.adoc[DocumentUpdaterService]`
** `xref:dv6@programmer:Edi:api/InvitationService.adoc[InvitationService]`
** `xref:dv6@programmer:Edi:api/LoaderService.adoc[LoaderService]`
** `xref:dv6@programmer:Edi:api/OutgoingMessagesService.adoc[OutgoingMessagesService]`
