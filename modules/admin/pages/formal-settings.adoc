...
.. Исходящий УПД (820).
.. Исходящий УПД (970)footnote:[В данный момент формат поддерживается только для коннекторов к Диадок и Такском.].
. Входящий УПД.
.. Входящий УПД (820).
.. Входящий УПД (970)footnote:[В данный момент формат поддерживается только для коннекторов к Диадок и Такском.].
.. Формализованный акт.
...
* `UniInvoiceSF`
* `UniInvoiceTorgRu`
* `UniInvoice970Rufootnote:[В данный момент формат поддерживается только для коннекторов к Диадок и Такском.]`
* `UniInvoiceAct970Rufootnote:[В данный момент формат поддерживается только для коннекторов к Диадок и Такском.]`
* `UniInvoiceSF970footnote:[В данный момент формат поддерживается только для коннекторов к Диадок и Такском.]`
* `UniInvoiceTorg970Rufootnote:[В данный момент формат поддерживается только для коннекторов к Диадок и Такском.]`
* `UniInvoiceAct552Ru`
...
* `UniInvoice970Ru` -- стандартный шаблон для вида _Входящий УПД (970)footnote:[В данный момент формат поддерживается только для коннекторов к Диадок и Такском.]_.
...
* `UniInvoice970Ru` -- стандартный шаблон для вида _Исходящий УПД (970)_.
