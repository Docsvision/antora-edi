...
[NOTE]
====
*С 9.02.2024* согласно https://normativ.kontur.ru/document?moduleId=1&documentId=464695#l1[приказу ФНС РФ от 19.12.2023 N ЕД-7-26/970@] в силу вступил новый формат УПД. Вместо карточек _Исходящий УПД_ нужно создавать карточки вида `Документ/УПД/Исходящий УПД/Исходящий УПД (970)`.
====
// end::820[]
--
+
.Карточка Исходящий УПД (970)
image::new-out-upd.png[Карточка Исходящий УПД (970)]
+
