...
* `UniInvoiceSF970footnote:[В данный момент формат поддерживается только для коннектора к Диадок.]`
...
* `UniInvoice970Ru` -- стандартный шаблон для вида _Входящий УПД (970)footnote:[В данный момент формат поддерживается только для коннектора к Диадок.]_.
